    ...
    workflows={
        ...
        "task": WorkflowDef(
            ...
            transitions=(
                ...
                TransitionDef("cancel", "Cancelar", ("backlog", "to_do", "in_progress", "in_review", "blocked"), "cancelled",
                    required_roles=("pm", "tech_lead"),
                    side_effects=("clear_blockers_on_cancel",)),
            ),
        ),
    },
    workflow_variants={
...
SCRUM_PACK = PackDef(
        ...
        "epic": WorkflowDef(
            ...
            transitions=(
                ...
                TransitionDef("review", "Mover a revisión", ("in_progress",), "in_review",
                    required_roles=("pm", "tech_lead"),
                    gates=("sprint_assigned",)),
                TransitionDef("complete", "Completar épica", ("in_review",), "done",
                    required_roles=("pm", "tech_lead"),
                    gates=("sprint_assigned",)),
                TransitionDef("reabrir", "Reabrir", ("done",), "in_review",
                    required_roles=("pm", "tech_lead"),
                    gates=("not_blocked_descendant",)),
                TransitionDef("reabrir", "Reabrir", ("in_review",), "in_progress",
                    required_roles=("pm", "tech_lead"),
                    gates=("not_blocked_descendant",)),
                TransitionDef("reabrir", "Reabrir", ("in_progress",), "to_do",
                    required_roles=("pm", "tech_lead"),
                    gates=("not_blocked_descendant",)),
                TransitionDef("cancel", "Cancelar épica", ("backlog", "to_do", "in_progress", "in_review", "blocked"), "cancelled",
                    required_roles=("pm",),
                    side_effects=("clear_blockers_on_cancel",)),
            ),
        ),
        ...
        "story": WorkflowDef(
            ...
            transitions=(
                ...
                TransitionDef("iniciar", "Iniciar", ("to_do",), "in_progress",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    gates=("not_blocked", "sprint_assigned")),
                TransitionDef("revisar", "Mover a revisión", ("in_progress",), "in_review",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    gates=("not_blocked", "sprint_assigned")),
                ...
                TransitionDef("devolver", "Devolver al backlog", ("to_do", "in_progress", "in_review", "blocked"), "backlog",
                    required_roles=("pm", "tech_lead"),
                    side_effects=("reparent_to_backlog",)),
                TransitionDef("cancelar", "Cancelar", ("backlog", "to_do", "in_progress", "in_review", "blocked"), "cancelled",
                    required_roles=("pm",),
                    side_effects=("clear_blockers_on_cancel",)),
                TransitionDef("reabrir", "Reabrir", ("done",), "in_review",
                    required_roles=("pm", "tech_lead"),
    ...
    capabilities_by_role={
        "pm": (
            ...
            "record.epic.transition.move", "record.epic.transition.cancel", "record.epic.transition.reabrir",
            ...
            "record.story.transition.reabrir",
            "record.dev_task.create", "record.dev_task.edit",
            "record.dev_task.transition.move", "record.dev_task.transition.cancel",
            "record.dev_task.transition.reabrir",
            "record.subtask.create", "record.subtask.edit",
            "record.subtask.transition.move", "record.subtask.transition.cancel",
            "record.subtask.transition.reabrir",
            "blocker.create", "blocker.resolve",
            "dependency.create", "dependency.delete",
            "member.add", "member.remove",
        ...
        "tech_lead": (
            ...
            "record.epic.create", "record.epic.transition.move", "record.epic.transition.reabrir",
        ...
        "dev": (
            ...
            "record.subtask.create", "record.subtask.edit",
            "record.subtask.transition.move",
