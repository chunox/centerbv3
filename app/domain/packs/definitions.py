...
WATERFALL_PACK = PackDef(
    ...
    workflows={
        "milestone": WorkflowDef(
            ...
            states=("pendiente", "en_progreso", "completado", "cancelado"),
            initial_state="pendiente",
            terminal_states=("completado", "cancelado"),
            transitions=(
                TransitionDef("iniciar", "Iniciar", ("pendiente",), "en_progreso",
                    required_roles=("pm", "tech_lead")),
                TransitionDef("completar", "Completar", ("en_progreso",), "completado",
                    required_roles=("pm", "tech_lead"),
                    side_effects=("sync_from_features",)),
                TransitionDef("cancelar", "Cancelar", ("pendiente", "en_progreso"), "cancelado",
                    required_roles=("pm",)),
            ),
        ),
        "feature": WorkflowDef(
            entity_type="feature",
            states=("pendiente", "en_progreso", "en_revision", "completado", "cancelado"),
            initial_state="pendiente",
            terminal_states=("completado", "cancelado"),
            transitions=(
                TransitionDef("iniciar", "Iniciar", ("pendiente",), "en_progreso",
                    ...
                    gates=("not_blocked",)),
                TransitionDef("revisar", "Mover a revisión", ("en_progreso",), "en_revision",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    gates=("not_blocked",)),
                TransitionDef("completar", "Completar", ("en_revision",), "completado",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    gates=("not_blocked",),
                    side_effects=("sync_parent_milestone",)),
                TransitionDef("cancelar", "Cancelar", ("pendiente", "en_progreso", "en_revision"), "cancelado",
                    required_roles=("pm", "tech_lead")),
            ),
        ),
        "task": WorkflowDef(
            entity_type="task",
            states=("backlog", "to_do", "in_progress", "en_revision", "completed", "cancel"),
            ...
            transitions=(
                ...
                TransitionDef("start", "Iniciar", ("to_do",), "in_progress",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    gates=("not_blocked", "dependency_satisfied")),
                TransitionDef("review", "Mover a revisión", ("in_progress",), "en_revision",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    gates=("not_blocked",)),
                TransitionDef("complete", "Completar", ("en_revision",), "completed",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    gates=("not_blocked",),
                    side_effects=("sync_parent_feature",)),
                TransitionDef("cancel", "Cancelar", ("backlog", "to_do", "in_progress", "en_revision"), "cancel",
                    required_roles=("pm", "tech_lead")),
            ),
        ),
    },
    workflow_variants={
        ...
        "feature.with_uat": WorkflowDef(
            entity_type="feature",
            states=("pendiente", "en_progreso", "en_revision", "uat", "completado", "cancelado"),
            initial_state="pendiente",
            terminal_states=("completado", "cancelado"),
            transitions=(
                TransitionDef("iniciar", "Iniciar", ("pendiente",), "en_progreso",
                ...
                TransitionDef("revisar", "Mover a revisión", ("en_progreso",), "en_revision",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    gates=("not_blocked",)),
                TransitionDef("pasar_a_uat", "Pasar a UAT", ("en_revision",), "uat",
                    required_roles=("pm", "tech_lead"),
                    gates=("not_blocked",)),
                TransitionDef("aprobar_uat", "Aprobar UAT", ("uat",), "completado",
                    required_roles=("pm",),
                    gates=("not_blocked",),
                    side_effects=("sync_parent_milestone",)),
                TransitionDef("rechazar_uat", "Rechazar — volver a revisión", ("uat",), "en_revision",
                    required_roles=("pm",)),
                TransitionDef("cancelar", "Cancelar", ("pendiente", "en_progreso", "en_revision", "uat"), "cancelado",
                    required_roles=("pm", "tech_lead")),
            ),
        ),
    },
...
SCRUM_PACK = PackDef(
    ...
    workflows={
        ...
        "epic": WorkflowDef(
            entity_type="epic",
            states=("product_backlog", "en_progreso", "completado", "cancelado"),
            initial_state="product_backlog",
            terminal_states=("completado", "cancelado"),
            transitions=(
                TransitionDef("iniciar", "Iniciar épica", ("product_backlog",), "en_progreso",
                    required_roles=("pm", "tech_lead")),
                TransitionDef("completar", "Completar épica", ("en_progreso",), "completado",
                    required_roles=("pm", "tech_lead")),
                TransitionDef("cancelar", "Cancelar épica", ("product_backlog", "en_progreso"), "cancelado",
                    required_roles=("pm",)),
            ),
        ),
        ...
        "story": WorkflowDef(
            entity_type="story",
            states=("product_backlog", "pendiente", "en_progreso", "en_revision", "completado", "cancelado"),
            initial_state="product_backlog",
            terminal_states=("completado", "cancelado"),
            transitions=(
                TransitionDef("comprometer", "Comprometer al sprint", ("product_backlog",), "pendiente",
                    required_roles=("pm", "tech_lead"),
                ...
                TransitionDef("revisar", "Mover a revisión", ("en_progreso",), "en_revision",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    gates=("not_blocked",)),
                TransitionDef("completar", "Completar historia", ("en_revision",), "completado",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    gates=("not_blocked",),
                    side_effects=("rollup_to_epic",)),
                TransitionDef("devolver", "Devolver al backlog", ("pendiente", "en_progreso", "en_revision"), "product_backlog",
                    required_roles=("pm", "tech_lead"),
                    side_effects=("reparent_to_backlog",)),
                TransitionDef("cancelar", "Cancelar", ("product_backlog", "pendiente", "en_progreso", "en_revision"), "cancelado",
                    required_roles=("pm",)),
            ),
        ),
        ...
        "subtask": WorkflowDef(
            entity_type="subtask",
            states=("backlog", "to_do", "in_progress", "completed", "cancel"),
            initial_state="backlog",
            terminal_states=("completed", "cancel"),
            transitions=(
                TransitionDef("start", "Iniciar", ("backlog", "to_do"), "in_progress",
                    required_roles=("pm", "tech_lead", "dev", "qa")),
                TransitionDef("complete", "Completar", ("in_progress",), "completed",
                    required_roles=("pm", "tech_lead", "dev", "qa"),
                    side_effects=("rollup_to_dev_task",)),
                TransitionDef("cancel", "Cancelar", ("backlog", "to_do", "in_progress"), "cancel",
                    required_roles=("pm", "tech_lead")),
            ),
        ),
    },
